...
public class NetworkProtocolStatisticsQuery extends BaseInfoQuery {
    public CustomSingleton<TcpStatisticsInfo> tcpIpv4Statistics;
    public CustomSingleton<TcpStatisticsInfo> tcpIpv6Statistics;
    public CustomSingleton<UdpStatisticsInfo> udpIpv4Statistics;
    public CustomSingleton<UdpStatisticsInfo> udpIpv6Statistics;
